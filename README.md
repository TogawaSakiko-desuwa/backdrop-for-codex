...
- 通过设置窗口实时切换壁纸、暂停或继续视频，并可从托盘恢复官方背景。
...
6. 在设置窗口切换壁纸或暂停视频；托盘菜单可打开设置、恢复官方背景或退出。恢复/退出伴侣不会关闭 CDP，使用完毕后请完全退出 Codex。
...
Pull Request 会在 Windows runner 上重新执行锁定依赖还原、Release 构建和单文件发布形态检查，并接受 CodeQL 分析。正式标签的 Release 工作流还会生成并校验 SBOM、SHA-256 与 GitHub 构建来源证明。
